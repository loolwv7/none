...
DIR1="/etc"	# Directories to backup daily
#DIR2="/home/oracle"		# (only 3 examples shown here, but
#DIR3="/etc"		#  more can be added DIR4, DIR5...)
...
EXL1="--exclude='resolv.conf'"
#EXL2="--exclude='*~'"
#EXL3=""

BKDIR="/opt/bak_config/"		# Where to store daily backups
BKDIRM="/opt/bak_config/"		# Where to store monthly backups
...
MakeIncrementalWeeklyBackup() {
  ...
  errortmp=0;
  $TAR $4 --newer="$1" -cpzf "$BKDIR/$COMPUTER-$DOW-$2.tar.gz" ;
  ErrorTest;
  if [ $CHMODCHOWN -eq 1 ] && \
